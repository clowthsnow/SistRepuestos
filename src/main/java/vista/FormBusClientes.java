 ...
 */
public class FormBusClientes extends javax.swing.JInternalFrame {
    DefaultTableModel modelo;

    /** Creates new form clientes */
    public FormBusClientes() {
    ...
    {
        String[]titulos={"Codigo","Nombres","Direccion","Correo","Telefono"} ;  
        String []Registros= new String[5];
        modelo=new DefaultTableModel(null,titulos);
        String Sql="SELECT * FROM cliente WHERE CONCAT(ClienteId,ClienteNombre,ClienteTelefono) LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 Registros[0]=rs.getString("ClienteId");  
                 Registros[1]=rs.getString("ClienteNombre");  
                 Registros[2]=rs.getString("ClienteDireccion");  
                 Registros[3]=rs.getString("ClienteCorreo");  
                 Registros[4]=rs.getString("ClienteTelefono");   
                 modelo.addRow(Registros);
             } 
             tbclientes.setModel(modelo);
        } catch (SQLException ex) {
            Logger.getLogger(FormBusClientes.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// TODO add your handling code here:
    ...
    try {
        ...
        else
        {
         ...
         dir =  (String)tbclientes.getValueAt(fila, 2);
         cor =  (String)tbclientes.getValueAt(fila, 3);
         tel =  (String)tbclientes.getValueAt(fila, 4);
         
         FormMantVentas.txtCodigoCliente.setText(cod);
         FormMantVentas.txtNombreCliente.setText(nom);
         FormMantVentas.txtDireccionCliente.setText(dir);
         FormMantVentas.txtCorreoCliente.setText(cor);
         FormMantVentas.txtTelefonoCliente.setText(tel);
